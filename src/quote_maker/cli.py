...
from quote_maker import __version__
from quote_maker.core.parser import parse_file
from quote_maker.core.prompt_builder import build_ai_prompt
from quote_maker.core.renderer import render
from quote_maker.core.validator import validate as validate_spec
from quote_maker.core.wizard_prompt import run_prompt_wizard, run_prompt_wizard_simple
...
app = typer.Typer(
    name="quote-maker",
    help="Generate a quotation Excel workbook from a YAML spec.",
...
def generate_cmd(
    input_path: Path = typer.Option(
        ...
        dir_okay=False,
        readable=True,
        help="Path to the quotation YAML spec.",
    ),
    ...
    """Parse a YAML spec and write the quotation workbook."""
    try:
    ...
    console.print(f"[green]Wrote quotation to[/green] {output}")
